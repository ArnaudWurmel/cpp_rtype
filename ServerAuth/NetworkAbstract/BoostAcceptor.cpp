...
void    NetworkAbstract::BoostAcceptor::startAccept() {
    std::shared_ptr<BoostSocket>    new_session(new BoostSocket(_ioService, _haveAction, _notifier));
