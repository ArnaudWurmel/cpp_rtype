...
NetworkAbstract::BoostSocket::BoostSocket(boost::asio::io_service& io_service, std::mutex& haveData, std::condition_variable& cv) : ISocket(haveData, cv), _socket(io_service), _readM(NetworkAbstract::Message::MessageType::Unknown) {
